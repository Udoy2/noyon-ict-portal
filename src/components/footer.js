...
<footer className="bg-white dark:bg-gray-900 ">
    <div className="grid grid-cols-1 gap-8 py-8 px-6 md:grid-cols-5 mx-auto max-w-[1240px]">
        <div>
            <h2 className="mb-6 text-sm font-bold text-[#000000] uppercase dark:text-gray-400">Company</h2>
        ...
        <div>
            <h2 className="mb-6 text-sm font-bold text-[#000] uppercase dark:text-gray-400">Help center</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li className="mb-4">
        ...
        <div>
            <h2 className="mb-6 text-sm font-bold text-[#000] uppercase dark:text-gray-400">Legal</h2>
            <ul className="text-gray-500 dark:text-gray-400">
                <li class="mb-4">
    ...
    <div className="py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://noyonictportal.com/">NoyonICTPortal™</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            ...
            <a href="https://github.com/wahid14k" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
